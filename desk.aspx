<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="desk.aspx.cs" Inherits="Storichain.WebSite.User.desk" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $('.btn_lk_srs').click(function (e) {
                e.preventDefault();

                location.href = 'series_make';
            });
            
            $('.btn_lk_wrt').click(function (e) {
                e.preventDefault();
        ...
        function doGetMyPost(myPostData) {
            ...
            $.each(myPostData.response_data, function (i, value) {
                ...
                var html = '<li>\
					            <div class="ct_thum">\
						            <a href="#"><img src="{0}" alt="" class="user_thum_img" /></a>\
					            </div>\
					            <div class="ct_info">\
    ...
    <div class="hnav_hd">
        <div class="nav_wrap">
            <ul class="hnav">
                ...
                <li class="m3 selected"><a href="desk"><strong>Desk</strong></a></li>
...
<div class="container">
    ...
    <div class="fx_btn ct_lk">
        ...
        <ul class="rd_btn">
            <li><a href="series_make" class="btn_lk_srs"><span class="blind">Create series</span></a></li>
            <li><a href="article/index" class="btn_lk_wrt"><span class="blind">Write</span></a></li>
        </ul>
    </div>
