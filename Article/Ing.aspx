<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ing.aspx.cs" Inherits="Storichain.WebSite.User.Ing" %>
    ...
    <script>
        ...
        function doGetMyPost(myPostData) {
            ...
            $.each(myPostData.response_data, function (i, value) {
                ...
                var liStr = stringFormat(
                    '<li>\
				        <a href="Edit?event_idx={3}&ing_yn=Y">\
        ...
        function doMoreMyPost(page, isScroll) {
            ...
            $.ajax({
                type: "POST",
                url: url,
                data: stringFormat("page={0}&page_rows={1}&topic_idx={2}&publish_yn=N&user_idx={3}", page, 20, $('#cbxCategory option:selected').val(), g_user_idx),
                dataType: "json",
                cache: false,
...
<body>
    ...
    %>
        ...
        <div class="header">
	        ...
	        <span class="user"><img src="<%= drUser.ImageUrl("user", "user") %>" alt="user" /></span>
        </div>
        ...
        <div class="wrap">
	        ...
	        <div class="asdie">
		        <aside id="aside">
			        <div class="user_info">
				        <div>
                            <img src="<%= drUser.ImageUrl("user", "user") %>" alt="<%= drUser.ItemValue("nick_name") %>" />
