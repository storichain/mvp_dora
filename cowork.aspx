<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cowork.aspx.cs" Inherits="Storichain.WebSite.User.cowork" %>
    ...
    <script type="text/javascript">
        ...
        function doGetMyPost(myPostData) {
            ...
            $.each(myPostData.response_data, function (i, value) {
                ...
                var private_view_yn      = value.private_view_yn;

                console.log('private_view_yn : ' + private_view_yn);
                
                var html = '<li class="{2}">\
					            <div class="cw_info">\
						            <h2><a href="#">{0}</a></h2>\
						            <div class="cw_thum">\
							            <a href="#"><img src="{1}" alt="" class="user_thum_img" /><span class="ic_public"></span></a>\
						            </div>\
						            <ul class="stats_lst">\
							            <li class="conum"><span>1000</span></li>\
							            <li class="cutin"><span>372</span></li>\
							            <li class="flag"><span></span></li>\
						            </ul>\
					            </div>\
				            </li>';
                ...
                var liStr = stringFormat(html
                    ...
                    , (private_view_yn == 'N')?'public':'npublic'
                    );
        ...
        function doMoreMyPost(page, isScroll) {
            ...
            $.ajax({
                ...
                data: stringFormat("page={0}&page_rows={1}&topic_idx={2}&publish_yn=Y&user_idx={3}&private_view_yn=", page, 8, $('#cbxCategory option:selected').val(), 0),
                dataType: "json",
                cache: false,
    ...
    <div class="hnav_hd">
        <div class="nav_wrap">
            <ul class="hnav">
                ...
                <li class="m4 selected"><a href="cowork"><strong>Cowork</strong></a></li>
            </ul>
        </div>
    </div>
</div>
...
<div class="container">
	...
	<div class="category">
		<div class="ct_wrap">
			<ul class="cat_lst" id='ulOpen'>
				<li data-value='0'><a href="#">나의작성모두</a></li>
				<li data-value='1'><a href="#">비공개</a></li>
				<li data-value='2'><a href="#" class="selected">시리즈</a></li>
				<li data-value='3'><a href="#">피드공개</a></li>
				<li data-value='4'><a href="#">전체공개</a></li>
				<li data-value='5'><a href="#">링크공개</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="content">
		<div class="ct_wrap">
			<ul class="cowork_lst" id="mlist">
                ...
                <%--<li class="public">
					<div class="cw_info">
						<h2><a href="#">김영하 선생님께 조언 듣는 합평회김영하 선생님께 조언 듣는 합평회김영하 선생님께 조언 듣는 합평회김영하 선생님께 조언 듣는 합평회</a></h2>
						<div class="cw_thum">
							<a href="#"><img src="/images/del/u2.png" alt="" class="user_thum_img" /><span class="ic_public"></span></a>
						</div>
						<ul class="stats_lst">
							<li class="conum"><span>1000</span></li>
							<li class="cutin"><span>372</span></li>
